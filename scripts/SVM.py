...
## 读取文件,转换为numpy格式
def load():
	x = np.loadtxt("./x_train", skiprows=1, delimiter ="\t", usecols=a)
...
print("the model has been complete!")
joblib.dump(clf, 'svm_model.pkl')
print("the model has been saved") 
## load model
## clf = joblib.load('filename.pkl') 
result = clf.score(x_test, y_test) # predict the target of testing samples   
print(result)
